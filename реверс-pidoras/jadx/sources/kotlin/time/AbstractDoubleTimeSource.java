...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark mo1391minusLRDsOJo(long duration) {
            return ComparableTimeMark.DefaultImpls.m1395minusLRDsOJo(this, duration);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: elapsedNow-UwyO8pc, reason: not valid java name */
        public long mo1390elapsedNowUwyO8pc() {
            return Duration.m1435minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo1393plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1436plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1392minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1405equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1432isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m1503getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1435minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m1405equalsimpl0(startedAtDiff, Duration.m1453unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m1503getZEROUwyO8pc() : Duration.m1436plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1405equalsimpl0(mo1392minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1503getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1428hashCodeimpl(Duration.m1436plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1449toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1503getZEROUwyO8pc(), null);
    }
}
