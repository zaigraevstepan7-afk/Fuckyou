...
final class ColorResourcesTableCreator {
    ...
    private static class StringPoolChunk {
        ...
        StringPoolChunk(boolean z, String... strArr) {
            ...
            int i = length % 4;
            this.stringsPaddingSize = i == 0 ? 0 : 4 - i;
            ...
            int i2 = this.stringsPaddingSize + length;
            this.styledSpansStart = z2 ? this.stringsStart + i2 : 0;
            this.chunkSize = this.stringsStart + i2 + (z2 ? size : 0);
