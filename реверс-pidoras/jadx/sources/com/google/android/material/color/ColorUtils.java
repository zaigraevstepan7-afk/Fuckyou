...
final class ColorUtils {
    ...
    public static int intFromLab(double l, double a, double b) {
        ...
        double x = ((double) WHITE_POINT_D65[0]) * xNormalized;
        double y = ((double) WHITE_POINT_D65[1]) * yNormalized;
        double z = ((double) WHITE_POINT_D65[2]) * zNormalized;
    ...
    public static int intFromLstar(float lstar) {
        ...
        float[] xyz = {WHITE_POINT_D65[0] * x, WHITE_POINT_D65[1] * y, WHITE_POINT_D65[2] * z};
