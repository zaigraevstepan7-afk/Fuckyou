    ...
    void dispatchOnSlide(int top) {
        ...
        if (bottomSheet != null && !this.callbacks.isEmpty()) {
            if (top > this.collapsedOffset || this.collapsedOffset == getExpandedOffset()) {
                slideOffset = (this.collapsedOffset - top) / (this.parentHeight - this.collapsedOffset);
            } else {
                slideOffset = (this.collapsedOffset - top) / (this.collapsedOffset - getExpandedOffset());
            }
            for (int i = 0; i < this.callbacks.size(); i++) {
