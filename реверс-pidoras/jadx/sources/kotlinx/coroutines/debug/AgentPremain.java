...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM75constructorimpl = Result.m75constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM75constructorimpl = Result.m75constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m81isFailureimpl(objM75constructorimpl) ? null : objM75constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1603installSignalHandler$lambda1(signal);
                }
            });
        } catch (Throwable th) {
        }
    ...
    public static final void m1603installSignalHandler$lambda1(Signal it) {
