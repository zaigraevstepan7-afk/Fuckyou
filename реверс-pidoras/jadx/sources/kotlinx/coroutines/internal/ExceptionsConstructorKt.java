...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        Object objM75constructorimpl;
        if (e instanceof CopyableThrowable) {
            try {
                Result.Companion companion = Result.INSTANCE;
                objM75constructorimpl = Result.m75constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM75constructorimpl = Result.m75constructorimpl(ResultKt.createFailure(th));
            }
            if (Result.m81isFailureimpl(objM75constructorimpl)) {
                objM75constructorimpl = null;
            }
            return (E) objM75constructorimpl;
        }
            ...
            case 0:
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$4
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        it.initCause(e);
                        objM75constructorimpl = Result.m75constructorimpl(it);
                        if (Result.m81isFailureimpl(objM75constructorimpl)) {
                            objM75constructorimpl = null;
                        }
                        return (Throwable) objM75constructorimpl;
                    }
                };
            case 1:
                ...
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createSafeConstructor$$inlined$safeCtor$2
                    ...
                    public final Throwable invoke(Throwable e) {
                        ...
                        objM75constructorimpl = Result.m75constructorimpl((Throwable) objNewInstance);
                        if (Result.m81isFailureimpl(objM75constructorimpl)) {
                            objM75constructorimpl = null;
                        }
                        return (Throwable) objM75constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    objM75constructorimpl = Result.m75constructorimpl(function12.invoke(e));
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM75constructorimpl = Result.m75constructorimpl(ResultKt.createFailure(th));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM75constructorimpl = Result.m75constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM75constructorimpl = Result.m75constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m81isFailureimpl(objM75constructorimpl)) {
            objM75constructorimpl = numValueOf;
        }
        return ((Number) objM75constructorimpl).intValue();
    }
