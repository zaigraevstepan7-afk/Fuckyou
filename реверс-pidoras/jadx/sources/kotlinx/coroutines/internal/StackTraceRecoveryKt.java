...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM75constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM75constructorimpl = Result.m75constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM75constructorimpl = Result.m75constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m78exceptionOrNullimpl(objM75constructorimpl) == null) {
            obj2 = objM75constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM75constructorimpl2 = Result.m75constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM75constructorimpl2 = Result.m75constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m78exceptionOrNullimpl(objM75constructorimpl2) == null) {
            obj = objM75constructorimpl2;
        }
