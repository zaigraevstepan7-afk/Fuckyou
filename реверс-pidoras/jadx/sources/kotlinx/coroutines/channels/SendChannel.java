...
public interface SendChannel<E> {
    ...
    Object mo1580trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1580trySendJP2dKIU(e);
            if (ChannelResult.m1595isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1589exceptionOrNullimpl = ChannelResult.m1589exceptionOrNullimpl(result);
            if (thM1589exceptionOrNullimpl == null) {
                return false;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1589exceptionOrNullimpl);
        }
    }
}
