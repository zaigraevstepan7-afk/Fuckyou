...
final /* synthetic */ class ChannelsKt__ChannelsKt {
            ...
            switch (this.label) {
                case 0:
                    ...
                    try {
                        ...
                        r = Result.m75constructorimpl(ResultKt.createFailure(th));
                    }
                    if (sendChannel.send(e, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    r = Result.m75constructorimpl(Unit.INSTANCE);
                    return ChannelResult.m1585boximpl(!Result.m82isSuccessimpl(r) ? ChannelResult.INSTANCE.m1600successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1598closedJP2dKIU(Result.m78exceptionOrNullimpl(r)));
                case 1:
                    try {
                        ResultKt.throwOnFailure($result);
                        r = Result.m75constructorimpl(Unit.INSTANCE);
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object $this$onSuccess_u2dWpGqRn0$iv = sendChannel.mo1580trySendJP2dKIU(e);
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (!ChannelResult.m1595isSuccessimpl(sendChannel.mo1580trySendJP2dKIU(e))) {
