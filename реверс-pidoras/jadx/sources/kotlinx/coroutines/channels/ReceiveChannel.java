...
public interface ReceiveChannel<E> {
    ...
    Object mo1578receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1579tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1579tryReceivePtdJZtk = receiveChannel.mo1579tryReceivePtdJZtk();
            if (ChannelResult.m1595isSuccessimpl(objMo1579tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1591getOrThrowimpl(objMo1579tryReceivePtdJZtk);
            }
            Throwable thM1589exceptionOrNullimpl = ChannelResult.m1589exceptionOrNullimpl(objMo1579tryReceivePtdJZtk);
        ...
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            switch (anonymousClass12.label) {
                case 0:
                    ...
                    objMo1578receiveCatchingJP2dKIU = receiveChannel.mo1578receiveCatchingJP2dKIU(anonymousClass12);
                ...
                case 1:
                    ResultKt.throwOnFailure($result);
                    objMo1578receiveCatchingJP2dKIU = ((ChannelResult) $result).getHolder();
                    break;
                default:
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
            }
            return ChannelResult.m1590getOrNullimpl(objMo1578receiveCatchingJP2dKIU);
        }
