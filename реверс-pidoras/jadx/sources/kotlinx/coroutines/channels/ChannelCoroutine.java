...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo1578receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo1578receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo1579tryReceivePtdJZtk() {
        return this._channel.mo1579tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* JADX INFO: renamed from: trySend-JP2dKIU */
    public Object mo1580trySendJP2dKIU(E element) {
        return this._channel.mo1580trySendJP2dKIU(element);
    }
