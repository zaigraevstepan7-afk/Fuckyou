...
public abstract class ObjectLongMap<K> {
    ...
    public final void forEach(Function2<? super K, ? super Long, Unit> block) {
        ...
        long[] m$iv = objectLongMap.metadata;
    ...
    */
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated) {
        ...
        ObjectLongMap<K> objectLongMap3 = this;
        int $i$f$forEach = 0;
        Object[] k$iv3 = objectLongMap3.keys;
        long[] v$iv = objectLongMap3.values;
        ObjectLongMap<K> objectLongMap4 = objectLongMap3;
        int $i$f$forEachIndexed3 = 0;
        long[] m$iv$iv = objectLongMap4.metadata;
        int lastIndex$iv$iv = m$iv$iv.length - 2;
        int i$iv$iv = 0;
        if (0 <= lastIndex$iv$iv) {
            loop0: while (true) {
                ...
                int i2 = i;
                int index2 = index;
                ObjectLongMap<K> objectLongMap5 = objectLongMap3;
                int $i$f$forEach2 = $i$f$forEach;
                long $this$maskEmptyOrDeleted$iv$iv$iv = ((~slot$iv$iv) << 7) & slot$iv$iv & (-9187201950435737472L);
                if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                    k$iv = k$iv3;
                    objectLongMap = objectLongMap4;
                ...
                i$iv$iv++;
                separator2 = separator;
                objectLongMap3 = objectLongMap5;
                $i$f$forEach = $i$f$forEach2;
                i = i2;
                objectLongMap4 = objectLongMap;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function2<? super K, ? super Long, ? extends CharSequence> transform) {
        ...
        ObjectLongMap<K> objectLongMap2 = objectLongMap;
        int $i$f$forEachIndexed = 0;
        long[] m$iv$iv3 = objectLongMap2.metadata;
        ...
        if (0 <= lastIndex$iv$iv) {
            loop0: while (true) {
                ...
                ObjectLongMap<K> objectLongMap3 = objectLongMap;
                ObjectLongMap<K> objectLongMap4 = objectLongMap2;
                int $i$f$forEachIndexed2 = $i$f$forEachIndexed;
                long $this$maskEmptyOrDeleted$iv$iv$iv = ((~slot$iv$iv) << 7) & slot$iv$iv & (-9187201950435737472L);
                if ($this$maskEmptyOrDeleted$iv$iv$iv != -9187201950435737472L) {
                    int i = 8;
    ...
    */
    public final int findKeyIndex(K key) {
        ...
        int hash2 = $i$f$hash & WorkQueueKt.MASK;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, Function2<? super K, ? super Long, ? extends CharSequence> transform) {
        ...
        ObjectLongMap<K> objectLongMap = this;
        int $i$f$forEach = 0;
        Object[] k$iv$iv = objectLongMap.keys;
        long[] v$iv$iv = objectLongMap.values;
        long[] m$iv$iv$iv3 = objectLongMap.metadata;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, Function2<? super K, ? super Long, ? extends CharSequence> transform) {
        ...
        Object[] k$iv$iv = objectLongMap.keys;
        long[] v$iv$iv = objectLongMap.values;
        long[] m$iv$iv$iv = objectLongMap.metadata;
