...
public abstract class ObjectFloatMap<K> {
    ...
    public final void forEach(Function2<? super K, ? super Float, Unit> block) {
        ...
        long[] m$iv = objectFloatMap.metadata;
    ...
    */
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, CharSequence truncated, Function2<? super K, ? super Float, ? extends CharSequence> transform) {
        ...
        ObjectFloatMap<K> objectFloatMap2 = objectFloatMap;
        int $i$f$forEachIndexed = 0;
        long[] m$iv$iv3 = objectFloatMap2.metadata;
        ...
        if (0 <= lastIndex$iv$iv) {
            loop0: while (true) {
                ...
                ObjectFloatMap<K> objectFloatMap3 = objectFloatMap;
                ObjectFloatMap<K> objectFloatMap4 = objectFloatMap2;
                int $i$f$forEachIndexed2 = $i$f$forEachIndexed;
                long $this$maskEmptyOrDeleted$iv$iv$iv = ((~slot$iv$iv) << 7) & slot$iv$iv & (-9187201950435737472L);
                if ($this$maskEmptyOrDeleted$iv$iv$iv != -9187201950435737472L) {
                    int i = 8;
                ...
                i$iv$iv++;
                separator2 = separator;
                objectFloatMap2 = objectFloatMap4;
                $i$f$forEachIndexed = $i$f$forEachIndexed2;
                objectFloatMap = objectFloatMap3;
                m$iv$iv3 = m$iv$iv;
            }
    ...
    */
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int limit, Function2<? super K, ? super Float, ? extends CharSequence> transform) {
        ...
        ObjectFloatMap<K> objectFloatMap = this;
        int $i$f$forEach = 0;
        Object[] k$iv$iv = objectFloatMap.keys;
        float[] v$iv$iv = objectFloatMap.values;
        long[] m$iv$iv$iv3 = objectFloatMap.metadata;
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, Function2<? super K, ? super Float, ? extends CharSequence> transform) {
        ...
        Object[] k$iv$iv = objectFloatMap.keys;
        float[] v$iv$iv = objectFloatMap.values;
        long[] m$iv$iv$iv = objectFloatMap.metadata;
