    ...
    */
    static void applyChainConstraints(ConstraintWidgetContainer container, LinearSystem system, int orientation, int offset, ChainHead chainHead) {
        ...
        if (!isChainSpread || firstVisibleWidget == null) {
            ...
            if (isChainSpreadInside && firstVisibleWidget != null) {
                ...
                if (beginTarget5 == null) {
                    ...
                    endTarget2 = endTarget4;
                    end2 = end8;
                    system.addCentering(begin7.mSolverVariable, beginTarget5.mSolverVariable, begin7.getMargin(), 0.5f, end8.mSolverVariable, endTarget4.mSolverVariable, end8.getMargin(), 5);
                } else {
                    endPointsStrength = 5;
                    endTarget2 = endTarget4;
                    end2 = end8;
                }
                ConstraintAnchor endTarget5 = endTarget2;
                if (endTarget5 != null && firstVisibleWidget != lastVisibleWidget) {
                    ConstraintAnchor end9 = end2;
                    system.addEquality(end9.mSolverVariable, endTarget5.mSolverVariable, -end9.getMargin(), endPointsStrength);
                }
            }
        } else {
        ...
        if ((!isChainSpread || isChainSpreadInside) && firstVisibleWidget != null && firstVisibleWidget != lastVisibleWidget) {
            ...
            SolverVariable endTarget6 = end72.mTarget == null ? end72.mTarget.mSolverVariable : null;
            if (last != lastVisibleWidget) {
                endTarget = endTarget6;
            } else {
                ConstraintAnchor realEnd = last.mListAnchors[offset + 1];
                SolverVariable endTarget7 = realEnd.mTarget != null ? realEnd.mTarget.mSolverVariable : null;
                endTarget = endTarget7;
            }
            if (firstVisibleWidget == lastVisibleWidget) {
                end = end72;
            } else {
            ...
            if (beginTarget == null && endTarget != null) {
                int beginMargin4 = begin52.getMargin();
                if (lastVisibleWidget == null) {
                    lastVisibleWidget = last;
                }
                int endMargin2 = lastVisibleWidget.mListAnchors[offset + 1].getMargin();
                system.addCentering(begin52.mSolverVariable, beginTarget, beginMargin4, 0.5f, endTarget, end.mSolverVariable, endMargin2, 5);
            }
        }
    }
}
