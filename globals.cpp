...
void *globals::get_lazysingleton_typeinfo(uintptr_t addr)
{
    ...
    if (!offset2)
        return nullptr;
    void *offset3 = *reinterpret_cast<void **>((uintptr_t)offset2 + oxorany(0xb8));
    if (!offset3)
        return nullptr;
...
void *globals::type_info_instance(uintptr_t addr, uintptr_t field)
{
    ...
    if (!type_info)
        return nullptr;
    void *static_field = *reinterpret_cast<void **>((uintptr_t)type_info + oxorany(0xb8));
    if (!static_field)
        return nullptr;
    void *instance = *reinterpret_cast<void **>((uintptr_t)static_field + oxorany(0x0));
    if (!instance)
        return nullptr;
    return instance;
}
