...
/* JADX INFO: renamed from: android.support.v4.graphics.drawable.۟ۧ۟ۧۢ, reason: contains not printable characters */
/* JADX INFO: loaded from: classes.dex */
public class C0009 {

    /* JADX INFO: renamed from: ۣۥۤ۟, reason: not valid java name and contains not printable characters */
    public static int f9 = -104;
    ...
    public static String m121(String str) {
        String string = "";
        int i = 0;
        String str2 = "";
        while (i < 15) {
    ...
    public static int m122() {
        return 628 ^ C0141.f147;
    }

    /* JADX INFO: renamed from: ۣ۠۠ۢ, reason: not valid java name and contains not printable characters */
