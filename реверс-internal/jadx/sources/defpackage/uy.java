...
public final class uy {
    ...
    public uy(int i, int i2, String str) {
        this.a = new ty(i, i2, str);
    }

    public static uy a(int i, int i2, boolean z, int i3, int i4, int i5, int i6) {
        String string;
        if (z) {
            int i7 = i / 2;
            int i8 = i2 / 2;
            StringBuilder sbN = s91.n("M0,", i8, " A", i7, ",");
            sbN.append(i8);
            sbN.append(" 0 1,1 ");
            sbN.append(i);
            sbN.append(",");
