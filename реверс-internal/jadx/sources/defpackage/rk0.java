...
public final class rk0 extends em {
    public final /* synthetic */ int d;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ rk0(int i, int i2, long j, String str) {
        super(str, j, i);
        this.d = i2;
    }
    ...
    public final float e(float f, float f2, float f3) {
        switch (this.d) {
            case 0:
                ...
                return (f4 > 0.20689656f ? f4 * f4 * f4 : 0.12841855f * (f4 - 0.13793103f)) * xi0.u[2];
            default:
                if (f3 < -2.0f) {
                    f3 = -2.0f;
                }
    ...
    public final long f(float f, float f2, float f3, float f4, em emVar) {
        switch (this.d) {
            case 0:
                ...
                return lk.c(f8, f9, f10 <= 128.0f ? f10 : 128.0f, f4, emVar);
            default:
                if (f < -2.0f) {
                    f = -2.0f;
                }
                ...
                return lk.c(f, f2, f3 <= 2.0f ? f3 : 2.0f, f4, emVar);
        }
    }
}
