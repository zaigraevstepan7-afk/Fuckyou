...
public final class gu implements j20 {
    ...
    public gu(float f, float f2, float f3, float f4) {
        ...
        if (!((Float.isNaN(f) || Float.isNaN(f2) || Float.isNaN(f3) || Float.isNaN(f4)) ? false : true)) {
            StringBuilder sbM = s91.m("Parameters to CubicBezierEasing cannot be NaN. Actual parameters are: ", f, ", ", f2, ", ");
            sbM.append(f3);
            sbM.append(", ");
            sbM.append(f4);
            sbM.append(".");
        ...
        double d5 = (d - d4) + d3;
        if (d5 == 0.0d) {
            iZ = d2 == d3 ? 0 : s22.Z((float) ((d4 - d3) / (d4 - (d3 * 2.0d))), fArr, 0);
        } else {
            double d6 = -Math.sqrt((d2 * d2) - (d3 * d));
            double d7 = (-d) + d2;
            int iZ2 = s22.Z((float) ((-(d6 + d7)) / d5), fArr, 0);
            int iZ3 = s22.Z((float) ((d6 - d7) / d5), fArr, iZ2) + iZ2;
            if (iZ3 > 1) {
                float f8 = fArr[0];
                float f9 = fArr[1];
                if (f8 > f9) {
        ...
        int iZ4 = s22.Z((-f10) / (((f7 - f6) * 2.0f) - f10), fArr, iZ) + iZ;
    ...
    */
    public final float b(float f) {
        ...
        if (Math.abs(d4 - 0.0d) >= 1.0E-7d) {
            ...
            if (d11 < 0.0d) {
                ...
                double dQ = xk.q((float) dSqrt) * 2.0f;
                float fCos = (float) ((Math.cos(dAcos / 3.0d) * dQ) - d12);
                ...
                if (Float.isNaN(f10)) {
                    float fCos2 = (float) ((Math.cos((6.283185307179586d + dAcos) / 3.0d) * dQ) - d12);
                    ...
                    if (Float.isNaN(f10)) {
                        float fCos3 = (float) ((Math.cos((dAcos + 12.566370614359172d) / 3.0d) * dQ) - d12);
                        if (fCos3 >= 0.0f) {
                            f8 = fCos3;
                        }
                        f2 = f8 > 1.0f ? 1.0f : f8;
                ...
                float fQ = (float) (((double) (xk.q((float) ((-d9) + dSqrt2)) - xk.q((float) (d9 + dSqrt2)))) - d12);
                if (fQ >= 0.0f) {
                    f8 = fQ;
                }
                f2 = f8 > 1.0f ? 1.0f : f8;
                if (Math.abs(f2 - fQ) <= 1.05E-6f) {
                }
            }
        ...
        StringBuilder sbM = s91.m("The cubic curve with parameters (", f4, ", ", f21, ", ");
        sbM.append(f6);
        sbM.append(", ");
        sbM.append(f20);
        sbM.append(") has no solution at ");
        sbM.append(f);
    ...
    public final boolean equals(Object obj) {
        ...
        gu guVar = (gu) obj;
        return this.e == guVar.e && this.f == guVar.f && this.g == guVar.g && this.h == guVar.h;
    }

    public final int hashCode() {
        return Float.hashCode(this.h) + s91.a(this.g, s91.a(this.f, Float.hashCode(this.e) * 31, 31), 31);
    }

    public final String toString() {
        StringBuilder sbM = s91.m("CubicBezierEasing(a=", this.e, ", b=", this.f, ", c=");
        sbM.append(this.g);
        sbM.append(", d=");
        sbM.append(this.h);
        sbM.append(")");
