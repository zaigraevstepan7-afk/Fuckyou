...
public final class lc1 implements InputConnection {
    public final y41 a;
    ...
    public lc1(az1 az1Var, y41 y41Var, boolean z) {
        this.a = y41Var;
        this.b = z;
        this.d = az1Var;
    }
    ...
    public final boolean b() {
        ...
        if (i == 0) {
            ...
            if (!arrayList.isEmpty()) {
                ((jz1) this.a.f).e.i(new ArrayList(arrayList));
                arrayList.clear();
            }
        }
        return this.c > 0;
    ...
    public final void closeConnection() {
        ...
        this.c = 0;
        this.h = false;
        ArrayList arrayList = ((jz1) this.a.f).i;
    ...
    public final CharSequence getSelectedText(int i) {
        ...
        return kd1.o(this.d).f;
    }

    @Override // android.view.inputmethod.InputConnection
    public final CharSequence getTextAfterCursor(int i, int i2) {
        return kd1.p(this.d, i).f;
    }

    @Override // android.view.inputmethod.InputConnection
    public final CharSequence getTextBeforeCursor(int i, int i2) {
        return kd1.q(this.d, i).f;
    }
    ...
    */
    ...
    public final boolean sendKeyEvent(KeyEvent keyEvent) {
        ...
        ((BaseInputConnection) ((jz1) this.a.f).j.getValue()).sendKeyEvent(keyEvent);
        return true;
    }
